...
// Task 4.
// С помощью alert выведите число 2019. После срабатывания кода - закомментируйте его, чтобы не мешал для дальнейшей 
...
// document.querySelector('h2.span').innerHTML = 'everyone';
...
// document.querySelector('.three').innerHTML = '<h3>Привет</h3>';
...
// document.querySelector('.four').innerHTML += '<h4>Привет</h4><p>МЕДВЕДЬ</p>';
